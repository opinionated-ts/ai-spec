...
2. **Checkout the [`proposal/template`](https://github.com/opinionated-ts/ai-spec/tree/proposal/template) branch** which contains the base structure for proposals.

3. **Open a PR** from your work with the specification (or section of it) you want to propose. See [proposal.instructions.md](./proposal.instructions.md) for detailed instructions on how to conduct your proposal.
